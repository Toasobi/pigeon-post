...
public class ReceiverStart {
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory filterContainerFactory(@Value("${pigeon.business.tagId.key}") String tagIdKey,
                                                                          @Value("${pigeon.business.tagId.value}") String tagIdValue) {
