...
import com.seeing.pigeon.common.dto.model.ContentModel;
...
import com.seeing.pigeon.support.utils.ContentHolderUtil;
import com.seeing.pigeon.support.utils.TaskInfoUtils;
...
public class AssembleAction implements BusinessProcess<SendTaskModel> {
    ...
    public void process(ProcessContext<SendTaskModel> context) {
        ...
        try {
            ...
            if (!messageTemplate.isPresent() || messageTemplate.get().getIsDeleted().equals(PigeonConstant.TRUE)) {
